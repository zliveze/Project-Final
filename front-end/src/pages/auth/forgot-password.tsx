...
// Import ForgotPasswordForm với dynamic để tránh lỗi hydration
...
const ForgotPasswordPage: NextPage = () => {
  ...
  return (
    <DefaultLayout>
      <Head>
        <title>Quên mật khẩu | Yumin Beauty</title>
        <meta name="description" content="Khôi phục lại mật khẩu tài khoản Yumin Beauty của bạn" />
      </Head>
