...
// Import LoginForm với dynamic để tránh lỗi hydration
...
const LoginPage: NextPage = () => {
  ...
  return (
    <DefaultLayout>
      <Head>
        <title>Đăng nhập | Yumin Beauty</title>
        <meta name="description" content="Đăng nhập vào tài khoản của bạn tại Yumin Beauty" />
      </Head>
