            ...
            <div className="flex-1">
              ...
              <div className="flex space-x-2 mt-1">
                ...
                <div className="bg-gray-50 px-6 py-4 sm:flex sm:flex-row-reverse border-t">
                  <button
                    type="button"
                    className="inline-flex items-center justify-center rounded-md bg-pink-600 px-4 py-2 text-sm font-semibold text-white shadow-sm hover:bg-pink-500 transition-colors sm:ml-3"
                    onClick={handleEdit}
                  >
                  ...
                  <button
                    type="button"
                    className="mt-3 inline-flex items-center justify-center rounded-md bg-white px-4 py-2 text-sm font-semibold text-gray-700 shadow-sm ring-1 ring-inset ring-gray-300 hover:bg-gray-50 transition-colors sm:mt-0"
                    onClick={onClose}
                  >
                    Đóng
                  </button>
