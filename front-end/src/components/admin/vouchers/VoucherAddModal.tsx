...
interface VoucherAddModalProps {
  ...
  initialData?: Partial<Voucher>; // Used for duplicating/copying a voucher
}

const VoucherAddModal: React.FC<VoucherAddModalProps> = ({
  isOpen,
  onClose,
  onSubmit,
  isSubmitting,
  initialData // Pass initialData for copy functionality
}) => {
        ...
        >
          ...
          <div className="max-h-[calc(85vh-8rem)] overflow-y-auto p-6">
            <VoucherForm
              ...
              isEditMode={false} // This is the Add modal
            />
          </div>
        </div>
      </div>
