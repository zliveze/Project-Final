          ...
          <div className="px-6 py-4">
            ...
            <div className="mt-6">
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                ...
                <div className="bg-gray-50 p-4 rounded-md border">
                  <h5 className="font-medium text-gray-700 mb-2">Đối tượng người dùng</h5>
                  <div className="space-y-1">
                    <p className="text-sm flex items-center">
                      <span className={voucher.applicableUserGroups?.all ? 'text-green-600' : 'text-gray-400'}>
                        {voucher.applicableUserGroups?.all ? <FiCheck className="inline mr-1" /> : <FiX className="inline mr-1" />}
                      </span>
                    ...
                    <p className="text-sm flex items-center">
                      <span className={voucher.applicableUserGroups?.new ? 'text-green-600' : 'text-gray-400'}>
                        {voucher.applicableUserGroups?.new ? <FiCheck className="inline mr-1" /> : <FiX className="inline mr-1" />}
                      </span>
                      <span className="text-gray-700">Người dùng mới</span>
                    </p>
                    {voucher.applicableUserGroups?.specific && voucher.applicableUserGroups?.specific.length > 0 && (
                      <div>
                        <p className="text-sm text-gray-700 mt-2">Người dùng cụ thể:</p>
                        <p className="text-sm text-gray-500 mt-1">{voucher.applicableUserGroups.specific.length} người dùng</p>
                      </div>
                    )}
                  </div>
                </div>
